...
<body>
    ...
    <main>
        ...
        <div>
            ...
            <a class="btn btn-danger ms-5" href="<?= ADDRESS_SITE ?>profil/manage/subscription/<?= $subscriptionId ?>/cancel" onclick="confirm('Voulez-vous vraiment annuler votre abonnement ?')?null:event.preventDefault()">Annuler l'abonnement</a>
